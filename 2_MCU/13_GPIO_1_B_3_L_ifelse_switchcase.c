	...
	while(1)
	{
		if(!(GPIOB->IDR & 0x100))
			...
			switch(press)
					{
					case 1:
						 GPIOA->ODR |= 0x80;//led PA7 ON
						 GPIOA->ODR &= ~0x100;//led PA8 OFF
						 GPIOA->ODR &= ~0x200;//led PA9 OFF
						 delay(100);
						 break;
					case 2:
						 GPIOA->ODR |=0x100;//led PA8 ON
						 GPIOA->ODR &= ~0x200;//led PA9 OFF
						 delay(100);
						 break;
					case 3:
						 GPIOA->ODR |=0x200;//led PA9 ON
						 delay(100);
						 break;
					case 4:
						GPIOA->ODR &= ~0x80;//led PA7 OFF
						GPIOA->ODR &= ~0x100;//led PA8 OFF
						GPIOA->ODR &= ~0x200;//led PA9 OFF
						 delay(100);
						 break;
